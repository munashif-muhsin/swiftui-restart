        ...
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                ZStack {
                    ...
                    // Get started text
                    Text("Get Started").font(.system(.title3, design: .rounded)).fontWeight(.bold).foregroundColor(.white)
                        .offset(x: 20)
                    
                    // Background circle
                    HStack {
                        Capsule().fill(Color("ColorRed")).frame(width: 80 + buttonOffset, alignment: .center)
                        Spacer()
                    }
